							...
							if(editID!=""&&editID!=null&&editID!=undefined){
								$.ajax({
									...
									success : function(msg) {
										...
										alert("保存成功!");
										window.location.href="user!showAllUserForPageAdmin.action";
									}
								});
							}
						},
      ...
      <div class="row-fluid">
        ...
        <button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
			...
			<div class="pagination" align="center">
				...
				<li><a href="user!showAllUserForPageAdmin.action?pageIndex=1">首页</a></li>
				<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex-1}">Prev</a></li>
				</c:if>
				<c:if test="${pager.pageIndex>=6}">
				<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex-1}">...</a></li>
				</c:if>
				<c:if test="${pager.pageIndex<=pager.totalPage }">
				<c:choose>
      			 <c:when test="${pager.pageIndex%5==1}">
              		<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex}">${pager.pageIndex}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==2}">
              		<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex-1}">${pager.pageIndex-1}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==3}">
              		<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex-2}">${pager.pageIndex-2}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==4}">
              		<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex-3}">${pager.pageIndex-3}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==0}">
              		<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex-4}">${pager.pageIndex-4}</a></li>
     			  </c:when>
      			 <c:otherwise>
	     		 </c:otherwise>
				</c:choose>
				...
				<c:if test="${pager.pageIndex<pager.totalPage }">
				<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.pageIndex+1}">Next</a></li>
				<li><a href="user!showAllUserForPageAdmin.action?pageIndex=${pager.totalPage}">最后一页</a></li>
				</c:if>
				</ul>
			</div>
			</div>
