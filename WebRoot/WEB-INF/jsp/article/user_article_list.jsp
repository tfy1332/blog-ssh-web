      ...
      <div class="row-fluid">
        ...
        <button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
			...
			<div class="pagination" align="center">
				...
				<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=1&username=${username}">首页</a></li>
				<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex-1}&username=${username}">Prev</a></li>
				</c:if>
				<c:if test="${pager.pageIndex>=6}">
				<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex-1}&username=${username}">...</a></li>
				</c:if>
				<c:if test="${pager.pageIndex<=pager.totalPage }">
				<c:choose>
      			 <c:when test="${pager.pageIndex%5==1}">
              		<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex}&username=${username}">${pager.pageIndex}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==2}">
              		<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex-1}&username=${username}">${pager.pageIndex-1}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==3}">
              		<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex-2}&username=${username}">${pager.pageIndex-2}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==4}">
              		<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex-3}&username=${username}">${pager.pageIndex-3}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==0}">
              		<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex-4}&username=${username}">${pager.pageIndex-4}</a></li>
     			  </c:when>
      			 <c:otherwise>
	     		 </c:otherwise>
				</c:choose>
				...
				<c:when test="${pager.pageIndex%5==1 &&pager.pageIndex+1<=pager.totalPage}">
     			  ...
     			  <c:when test="${pager.pageIndex%5==4}">
              		<li><a href="article!showAllArticleForPageTestUserTestUser.action?pageIndex=${pager.pageIndex-2}&username=${username}">${pager.pageIndex-2}</a></li>
     			  </c:when>
     			  <c:when test="${pager.pageIndex%5==0}">
              		<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex-3}&username=${username}">${pager.pageIndex-3}</a></li>
     			  </c:when>
				...
				<c:if test="${pager.pageIndex<pager.totalPage }">
				<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.pageIndex+1}&username=${username}">Next</a></li>
				<li><a href="article!showAllArticleForPageTestUser.action?pageIndex=${pager.totalPage}&username=${username}">最后一页</a></li>
				</c:if>
				</ul>
			</div>
