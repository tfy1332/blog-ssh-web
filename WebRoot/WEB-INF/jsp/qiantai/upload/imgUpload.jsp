...
<html lang="en">
	<head>
		...
		<script src="<%=request.getContextPath() %>/jquery-ui-1.10.4.custom/js/jquery-1.10.2.js"></script>
		<script src="<%=request.getContextPath() %>/jquery-ui-1.10.4.custom/js/jquery-ui-1.10.4.custom.js"></script>
		<script src="<%=request.getContextPath() %>/jquery-ui-1.10.4.custom/js/jquery-ui-1.10.4.custom.min.js"></script>
		        ...
		        var Qiniu_upload = function(f, token, key) {
		            ...
		            xhr.onreadystatechange = function(response) {
		                if (xhr.readyState == 4 && xhr.status == 200 && xhr.responseText != "") {
		                    ...
		                    //alert(blkRet);
		                   // alert("hash="+blkRet.hash);
		                    //alert("key="+blkRet.key);
		                    $("#dialog").html(xhr.responseText).dialog();
		                    window.location.href = "upload!showUserImagesForPager.action?hash="+blkRet.hash+"&key="+blkRet.key;
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div>
								...
								<form method="post" action="upload!uploadImagesToQiniuForPager.action" enctype="multipart/form-data">
								<ul>
						    <li>
						        <label for="token">token--Ajax:</label>
						        <input id="token" name="token" class="ipt" value="${uptoken}" disabled="disabled">
						        <!--  
						    ...
						    <li>
						        <input id="btn_upload_qiniu" type="submit" value="提交">
						        <!-- 
								...
								<form method="post" action="http://up.qiniu.com" enctype="multipart/form-data">
								    <ul>
								        <li>
								            ...
								            <input id="token" name="token" class="ipt" value="${uptoken}"><a target="blank" href="http://jsfiddle.net/gh/get/extjs/4.2/icattlecoder/jsfiddle/tree/master/uptoken">在线生成token</a>
