	...
	<body class="no-skin">
		...
		<div id="navbar" class="navbar navbar-default">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<c:forEach items="${imageList}" var="image" varStatus="images">
				<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#">
												上传图列表${image.img_key}<img src="http://tfyworld.qiniudn.com/${image.img_key}" class="msg-photo" alt="TFY" />
												<span class="msg-body">
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
										...
										<c:forEach items="${imageList}" var="image" varStatus="images">
											...
											<li>
												<a href="#">
													上传图列表${image.img_key}<img src="http://tfyworld.qiniudn.com/${image.img_key}" class="msg-photo" alt="Kate's Avatar" />
													<span class="msg-body">
														<span class="msg-title">
															<span class="blue">Kate:</span>
															Ciao sociis natoque eget urna mollis ornare ...
