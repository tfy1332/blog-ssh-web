...
<link href="<%=request.getContextPath() %>/ckeditor/plugins/codesnippet/lib/highlight/styles/default.css" rel="stylesheet">
 ...
 <script src="<%=request.getContextPath() %>/ckeditor/plugins/codesnippet/lib/highlight/highlight.pack.js"></script>
 
 <script type="text/javascript" src="<%=request.getContextPath() %>/syntaxhighlighter_3.0.83/scripts/shCore.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath() %>/syntaxhighlighter_3.0.83/scripts/shBrushJScript.js"></script>
	<link type="text/css" rel="stylesheet" href="<%=request.getContextPath() %>/syntaxhighlighter_3.0.83/styles/shCoreDefault.css"/>
    ...
    <div class="container-fluid" id="left">
      <div class="row-fluid">
        ...
        <div class="span9"  id="rightMain" >
			...
			<span class="link_edit" class="link_edit"  <c:if test="${username==null||username=='' || username!=article.authorName}">style="display: none;"</c:if> >
			<a title="编辑" href="article!toUpdateUI.action?id=${article.id}">编辑</a>
			</span>
			
			<span class="link_delete" <c:if test="${username==null||username==''|| username!=article.authorName}">style="display: none;"</c:if>>
			<a title="删除" onclick="javascript:delArticle('${article.id}');return false;" href="javascript:void(0);">删除</a>
				...
				<p class="subtit"><span id="autosave_note">${article.content_html}</span></p>
