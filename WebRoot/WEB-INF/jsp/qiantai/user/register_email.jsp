...
.required {
    ...
    font-weight: bold;
		...
		<meta charset="utf-8" />
		<title>程序员忘记密码---找回密码(Coder)- Ace Admin</title>
									...
									<table  align="center" width="546px" height="346px" background="../assets/images/yxjh.jpg">
										<tr><td>
											...
											<tr><td><div style="text-align:center;font-family:'微软雅黑','宋体';font-size:18px;color:#000000;" class="cjcx_1">
											  ...
											  <tr height="40">
												<td width="406" class="font-black-14"><font style="font-weight:bold; color:#ff6f66;">mc1109</font>，就差一步了，点击【<a href="email.html">登录邮箱</a>】去激活您的帐号吧！
												</td>
											  </tr>
											</table></td></tr>
									</table>
