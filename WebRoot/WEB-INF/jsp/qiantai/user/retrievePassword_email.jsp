...
.required {
    ...
    font-weight: bold;
		...
		<meta charset="utf-8" />
		<title>程序员忘记密码---找回密码----登录邮箱(Coder)- Ace Admin</title>
					...
					<ul id="myTab" class="nav nav-tabs">
							...
							<form class="form-horizontal" role="form">
								...
								<div class="form-group">
									<table  align="center" width="546px" height="346px" background="../assets/images/yxjh.jpg">
										<tr><td>
											<table width="413" height="57" border="0" align="center" cellpadding="0" cellspacing="0" >
											<tr><td><div style="text-align:center;font-family:'微软雅黑','宋体';font-size:18px;color:#000000;" class="cjcx_1">
											  <p>找回密码<hr></p>
											  <p>&nbsp;</p>
											</div></td></tr>
											  <tr height="40">
												<td width="406" class="font-black-14"><font style="font-weight:bold; color:#ff6f66;">${email}</font>就差一步了，点击【<a href="${email_url}">登录邮箱</a>】去找回找回您的账户密码吧！
												</td>
											  </tr>
											</table></td></tr>
									</table>
