			...
			<div class="main-content">
			  ...
			  <div class="page-content"><!-- 原 page-content -->
					...
					<ul id="myTab" class="nav nav-tabs">
                            ...
                            <!-- /.page-header -->
							<!-- PAGE CONTENT BEGINS -->
							<form id="addProject" class="form-horizontal" role="form" action="project!saveProject.action?id=${user.id}" method="post">
						  ...
						  <div class="col-sm-3 control-label no-padding-right">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input id="project_name" name="project_name" type="text"  placeholder="项目名称" class="col-xs-10 col-sm-5" value="${user.work_years}"/>
									</div>
								</div>
									...
									<div class="col-sm-9">
									  <div class="input-group col-xs-10 col-sm-5">
										<select id="development_tool" name="development_tool" class="chosen-select"  data-placeholder="Choose a State...">
							                <option value="JAVA" <c:if test="${user.programming_language eq 'JAVA'}">selected</c:if> >MyEclipse</option>
							                <option value="SWIFT" <c:if test="${user.programming_language eq 'SWIFT'}">selected</c:if> >Eclipse</option>
							                <option value="C" <c:if test="${user.programming_language eq 'C'}">selected</c:if> >Microsoft Visual Studio</option>
							                 <option value="C++" <c:if test="${user.programming_language eq 'C++'}">selected</c:if> >ADT</option>
							                <option value="PHP" <c:if test="${user.programming_language eq 'PHP'}">selected</c:if>>Dreamweaver</option>
							                
							                 <option value="Python" <c:if test="${user.programming_language eq 'Python'}">selected</c:if> >NetBeans</option>
							                <option value="SQL" <c:if test="${user.programming_language eq 'SQL'}">selected</c:if> >Jcreator</option>
							                <option value="OBJECT_C" <c:if test="${user.programming_language eq 'OBJECT_C'}">selected</c:if> >XCODE</option>
							                 <option value="C#" <c:if test="${user.programming_language eq 'C#'}">selected</c:if> >PL_SQL</option>
							                <option value=".NET" <c:if test="${user.programming_language eq '.NET'}">selected</c:if> >NAVICAT</option>
							            </select>
                                    </div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="framework" name="framework" placeholder="使用框架或者技术" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="function_Introduction" name="function_Introduction" placeholder="功能介绍" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="developing_functional" name="developing_functional" placeholder="参与开发功能" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="development_address" name="development_address" placeholder="开发地点" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="team_size" name="team_size" placeholder="团队人数" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">上线时间<span class="required">*</span> </label>
									  ...
									  <div class="col-sm-9">
										<div class="input-group col-xs-10 col-sm-5">										
										<input id="online_time"  name="online_time" type="text" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" value="${user.birthday}"><span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="project_cost" name="project_cost" placeholder="项目费用" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <label class="col-xs-1 no-padding-left"><input type="radio" class="ace" name="is_intelnet_access" <c:if test="${user.sex eq '男'}">checked</c:if> value="是"> <span class="lbl"> 是</span></label>
                                      <label class="col-xs-1  no-padding-left"><input type="radio" class="ace" name="is_intelnet_access" <c:if test="${user.sex eq '女'}">checked</c:if> value="否"><span class="lbl"> 否</span></label>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="intelnet_URL" name="intelnet_URL" placeholder="外网访问地址" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
															<div class="input-daterange input-group">
																<input type="text" class="date-picker form-control" name="start_Date_pro" id="start_Date_pro" data-date-format="yyyy-mm-dd" />
																<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i>
																</span>
																...
																<input type="text" class="date-picker form-control" name="end_Date_pro"  id="end_Date_pro" data-date-format="yyyy-mm-dd"/>
																<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i>
																</span>
															</div>
								...
								<div class="clearfix form-actions">
									<div class="col-md-offset-3 col-md-9">
										<button class="btn btn-info" type="button" onclick="savePro();">
