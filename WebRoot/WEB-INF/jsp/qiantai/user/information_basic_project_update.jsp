...
<link rel="stylesheet" href="${pageContext.request.contextPath}/jquery-easyui-1.3.6/themes/icon.css" type="text/css"></link>
		...
		function  updatePro(){
	        ...
	        //alert(first_name);
	        if(development_language=="" ||development_language==undefined){
	            alert("开发语言不能为空!");
	            return ;
	        }

	        var development_tool=$("#development_tool").val();
	        //alert(last_name);
	        if(development_tool=="" ||development_tool==undefined){
	            alert("开发工具不能为空!");
	            return ;
	        }
	        var development_database=$("#development_database").val();
	        //alert(first_name);
	        if(development_database=="" ||development_database==undefined){
	            alert("数据库不能为空!");
	            return ;
	        }
	        ...
	        var function_Introduction=$("#function_Introduction").val();
	        //alert(last_name);
	        if(function_Introduction=="" ||function_Introduction==undefined){
	            alert("功能介绍不能为空!");
	            return ;
	        }
	        var developing_functional=$("#developing_functional").val();
	        //alert(first_name);
	        if(developing_functional=="" ||developing_functional==undefined){
	            alert("参与开发功能不能为空!");
	            return ;
	        }

	        var development_address=$("#development_address").val();
	        //alert(last_name);
	        if(development_address=="" ||development_address==undefined){
	            alert("开发地点不能为空!");
	            return ;
	        }
	        ...
	        //alert(last_name);
	        if(team_size=="" ||team_size==undefined){
	            alert("团队人数不能为空!");
	            return ;
	        }
	        ...
	        //alert(first_name);
	        if(online_time=="" ||online_time==undefined){
	            alert("上线时间不能为空!");
	            return ;
	        }
	        var project_cost=$("#project_cost").val();
	        //alert(first_name);
	        if(project_cost=="" ||project_cost==undefined){
	            alert("项目费用不能为空!");
	            return ;
	        }

	        var is_intelnet_access=$('input:radio:checked').val();
		       // alert(sex);
		        if(is_intelnet_access=="" ||is_intelnet_access==undefined){
		            alert("外网是否能访问不能为空!");
		            return ;
		        }
		        
	        var intelnet_URL=$("#intelnet_URL").val();
	        //alert(last_name);
	        if(intelnet_URL=="" ||intelnet_URL==undefined){
	            alert("外网访问地址 不能为空!");
	            return ;
	        }
	        var start_Date=$("#start_Date_pro").val();
	        //alert(first_name);
			...
			<div class="main-content">
			  ...
			  <div class="page-content"><!-- 原 page-content -->
					...
					<ul id="myTab" class="nav nav-tabs">
                            ...
                            <!-- /.page-header -->
							<!-- PAGE CONTENT BEGINS -->
							<form id="updateProject" class="form-horizontal" role="form" action="project!updateProject.action?id=${user.id}" method="post">
						...
						<input type="hidden" name="projectID" value="${project.id}" id="projectID">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 项目名称<span class="required">*</span> </label>

									<div class="col-sm-9">
									  <input id="project_name" name="project_name" type="text"  placeholder="项目名称" class="col-xs-10 col-sm-5" value="${project.project_name}"/>
									</div>
								</div>
								
								
								 <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">编程语言<span class="required">*</span> </label>

									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="development_language" name="development_language" class="chosen-select"  data-placeholder="Choose a State...">
							                <option value="JAVA" <c:if test="${project.development_language eq 'JAVA'}">selected</c:if> >JAVA</option>
							                <option value="SWIFT" <c:if test="${project.development_language eq 'SWIFT'}">selected</c:if> >SWIFT</option>
							                <option value="C" <c:if test="${project.development_language eq 'C'}">selected</c:if> >C</option>
							                 <option value="C++" <c:if test="${project.development_language eq 'C++'}">selected</c:if> >C++</option>
							                <option value="PHP" <c:if test="${project.development_language eq 'PHP'}">selected</c:if>>PHP</option>
							                
							                 <option value="Python" <c:if test="${project.development_language eq 'Python'}">selected</c:if> >Python</option>
							                <option value="SQL" <c:if test="${project.development_language eq 'SQL'}">selected</c:if> >SQL</option>
							                <option value="OBJECT_C" <c:if test="${project.development_language eq 'OBJECT_C'}">selected</c:if> >OBJECT_C</option>
							                 <option value="C#" <c:if test="${project.development_language eq 'C#'}">selected</c:if> >C#</option>
							                <option value=".NET" <c:if test="${project.development_language eq '.NET'}">selected</c:if> >.NET</option>
							            </select>
                                    </div>
                                    </div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <div class="input-group col-xs-10 col-sm-5">
										<select id="development_tool" name="development_tool" class="chosen-select"  data-placeholder="Choose a State...">
							                <option value="JAVA" <c:if test="${project.development_tool eq 'JAVA'}">selected</c:if> >MyEclipse</option>
							                <option value="SWIFT" <c:if test="${project.development_tool eq 'SWIFT'}">selected</c:if> >Eclipse</option>
							                <option value="C" <c:if test="${project.development_tool eq 'C'}">selected</c:if> >Microsoft Visual Studio</option>
							                 <option value="C++" <c:if test="${project.development_tool eq 'C++'}">selected</c:if> >ADT</option>
							                <option value="PHP" <c:if test="${project.development_tool eq 'PHP'}">selected</c:if>>Dreamweaver</option>
							                
							                 <option value="Python" <c:if test="${project.development_tool eq 'Python'}">selected</c:if> >NetBeans</option>
							                <option value="SQL" <c:if test="${project.development_tool eq 'SQL'}">selected</c:if> >Jcreator</option>
							                <option value="OBJECT_C" <c:if test="${project.development_tool eq 'OBJECT_C'}">selected</c:if> >XCODE</option>
							                 <option value="C#" <c:if test="${project.development_tool eq 'C#'}">selected</c:if> >PL_SQL</option>
							                <option value=".NET" <c:if test="${project.development_tool eq '.NET'}">selected</c:if> >NAVICAT</option>
							            </select>
                                    </div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="development_database" name="development_database" class="chosen-select" id="form-field-select-3" data-placeholder="Choose a State...">
							                <option value="ORACLE" <c:if test="${project.development_database eq 'ORACLE'}">selected</c:if> >ORACLE</option>
							                <option value="MYSQL" <c:if test="${project.development_database eq 'MYSQL'}">selected</c:if> >MYSQL</option>
							                <option value="SQL server" <c:if test="${project.development_database eq 'SQL server'}">selected</c:if> >SQL server</option>
							                 <option value="DB2" <c:if test="${project.development_database eq 'DB2'}">selected</c:if> >DB2</option>
							                <option value="Sybase" <c:if test="${project.development_database eq 'Sybase'}">selected</c:if> >Sybase</option>
									...
									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="server"  name="server"  class="chosen-select"  data-placeholder="Choose a State...">
							                <option value="Tomcat"<c:if test="${project.server eq 'Tomcat'}">selected</c:if> >Tomcat</option>
							                <option value="WebLogic" <c:if test="${project.server eq 'WebLogic'}">selected</c:if> >WebLogic</option>
							                <option value="JBoss" <c:if test="${project.server eq 'JBoss'}">selected</c:if> >JBoss</option>
							                 <option value="WebSphere" <c:if test="${project.server eq 'WebSphere'}">selected</c:if> >WebSphere</option>
							                <option value="Apache" <c:if test="${project.server eq 'Apache'}">selected</c:if> >Apache</option>
							                
							                 <option value="Nginx" <c:if test="${project.server eq 'Nginx'}">selected</c:if> >Nginx</option>
							            </select>
                                    </div>
                                    </div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="framework" name="framework" placeholder="使用框架或者技术" class="col-xs-10 col-sm-5" value="${project.framework}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="function_Introduction" name="function_Introduction" placeholder="功能介绍" class="col-xs-10 col-sm-5" value="${project.function_Introduction}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="developing_functional" name="developing_functional" placeholder="参与开发功能" class="col-xs-10 col-sm-5" value="${project.developing_functional}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="development_address" name="development_address" placeholder="开发地点" class="col-xs-10 col-sm-5" value="${project.development_address}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="team_size" name="team_size" placeholder="团队人数" class="col-xs-10 col-sm-5" value="${project.team_size}"/>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">上线时间<span class="required">*</span> </label>
									  ...
									  <div class="col-sm-9">
										<div class="input-group col-xs-10 col-sm-5">										
										<input id="online_time"  name="online_time" type="text" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" value="${project.online_time}"><span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="project_cost" name="project_cost" placeholder="项目费用" class="col-xs-10 col-sm-5" value="${project.project_cost}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <label class="col-xs-1 no-padding-left"><input type="radio" class="ace" name="is_intelnet_access" <c:if test="${project.is_intelnet_access eq '是'}">checked</c:if> value="是"> <span class="lbl"> 是</span></label>
                                      <label class="col-xs-1  no-padding-left"><input type="radio" class="ace" name="is_intelnet_access" <c:if test="${project.is_intelnet_access eq '否'}">checked</c:if> value="否"><span class="lbl"> 否</span></label>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input type="text" id="intelnet_URL" name="intelnet_URL" placeholder="外网访问地址" class="col-xs-10 col-sm-5" value="${project.intelnet_URL}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input id="start_Date"  name="start_Date" type="text" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" value="${user.birthday}">
										...
										<div class="input-group col-xs-10 col-sm-4">										
										<input id="end_Date"  name="end_Date" type="text" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" value="${user.birthday}">
										<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i>
										</span>
										</div>
									</div>
										...
										<input id="birthday"  name="birthday" type="text" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" value="${user.birthday}">
										<span class="col-xs-5 input-group-addon"><i class="fa fa-calendar bigger-110"></i>
										</span>
										</div>
									 -->
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
															<div class="input-daterange input-group">
																<input type="text" class="date-picker form-control" name="start_Date_pro" id="start_Date_pro" data-date-format="yyyy-mm-dd" value="${project.start_Date}"/>
																<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i>
																</span>
																...
																<input type="text" class="date-picker form-control" name="end_Date_pro"  id="end_Date_pro" data-date-format="yyyy-mm-dd" value="${project.end_Date}"/>
																<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i>
																</span>
															</div>
