...
<link rel="stylesheet" href="${pageContext.request.contextPath}/jquery-easyui-1.3.6/themes/icon.css" type="text/css"></link>
		...
		function  save(){
	       ...
	       // alert(sex);
	        ...
	        //alert(work_years);
	        if(work_years=="" ||work_years==undefined){
	            alert("工作年限不能为空!");
	            return ;
	        }
	        var programming_language=$("#programming_language").val();
	        //alert(programming_language);
	        if(programming_language=="" ||programming_language==undefined){
	            alert("擅长编程语言不能为空!");
	            return ;
	        }
	        var good_at_database=$("#good_at_database").val();
	        //alert(good_at_database);
	        if(good_at_database=="" ||good_at_database==undefined){
	            alert("擅长数据库不能为空!");
	            return ;
	        }
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="user!showUserBasicInfo?id=<%= session.getAttribute("userID")%> " >
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
						<li class="">
								<a href="upload!showUserImagesForPager.action?id=<%= session.getAttribute("userID")%> ">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="user!showUserBeautifulGallery?id=<%= session.getAttribute("userID")%> ">
									<i class="menu-icon fa fa-caret-right"></i>
									很炫很酷的(图片显示)--LOOK
							...
							<li class="">
								<a href="forward!showForwardPage.action?id=<%= session.getAttribute("userID")%> ">
									<i class="menu-icon fa fa-caret-right"></i>
									上传图片
								</a>
			  ...
			  <div class="page-content"><!-- 原 page-content -->
					...
					<ul id="myTab" class="nav nav-tabs">
							<li class="active">
                                    ...
                                    <li>
									<a href="user!showUserResume.action?id=<%= session.getAttribute("userID")%> ">
                                    ...
                                    <li>
									<a href="user!showUserSelfsetup.action?id=<%= session.getAttribute("userID")%> ">
									...
									<li>
									<a href="user!showUserCoderInfo.action?id=<%= session.getAttribute("userID")%> ">
									<i class="green ace-icon fa    fa-bolt bigger-120"></i>
                                    程序员预览
									</a>
									</li>
                            ...
                            <!-- /.page-header -->
							<!-- PAGE CONTENT BEGINS -->
							<form id="basicInfo" class="form-horizontal" role="form" action="user!saveUserBasicInfo.action?id=${user.id}" method="post">
                                ...
                                <div class="col-xs-12 col-sm-2 center">
									  <div>
											...
											<a href="#upload_img" role="button" class="green" data-toggle="modal">
											...
											<c:if test="${user.image != '' && user.image !=null}">
												<img src="http://tfyworld.qiniudn.com/${user.image}" alt="Alex's Avatar" class="editable img-responsive editable-click editable-empty" id="avatar" ></img>
											</c:if>			
								</a>
											
									</span>
											<div id="user_image" style="font-size: 15px;">
						  ...
						  <div class="col-sm-3 control-label no-padding-right">
								...
								<a href="user!updateUserbasiInfo?id=<%= session.getAttribute("userID")%>" role="button" class="green" data-toggle="modal">
								修改基本信息</a>
								</h4>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="last_name" name="last_name" placeholder="姓" class="col-xs-2"  value="${user.last_name}"/>
                                        <div class="col-xs-1 control-label"></div>
                                        <input type="text" id="first_name" name="first_name"  placeholder="名" class="col-xs-2" value="${user.first_name}"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <label class="col-xs-1 no-padding-left"><input type="radio" class="ace" name="sex" <c:if test="${user.sex eq '男'}">checked</c:if> value="男"> <span class="lbl"> 男</span></label>
                                      <label class="col-xs-1  no-padding-left"><input type="radio" class="ace" name="sex" <c:if test="${user.sex eq '女'}">checked</c:if> value="女"><span class="lbl"> 女</span></label>
								...
								<div class="form-group">
								  ...
								  <div class="col-sm-9">
										...
										<input id="birthday"  name="birthday" type="text" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" value="${user.birthday}"><span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
										</div>
									</div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
										<input id="show_name" name="show_name" type="text" id="form-field-1" placeholder="展示页显示名" class="col-xs-10 col-sm-5" value="${user.show_name}"/>
									</div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
									  <input id="work_years" name="work_years" type="text" id="form-field-1" placeholder="工作年限" class="col-xs-10 col-sm-5" value="${user.work_years}"/>
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="programming_language" name="programming_language" class="chosen-select" id="form-field-select-3" data-placeholder="Choose a State...">
							                <option value="JAVA" <c:if test="${user.programming_language eq 'JAVA'}">selected</c:if> >JAVA</option>
							                <option value="SWIFT" <c:if test="${user.programming_language eq 'SWIFT'}">selected</c:if> >SWIFT</option>
							                <option value="C" <c:if test="${user.programming_language eq 'C'}">selected</c:if> >C</option>
							                 <option value="C++" <c:if test="${user.programming_language eq 'C++'}">selected</c:if> >C++</option>
							                <option value="PHP" <c:if test="${user.programming_language eq 'PHP'}">selected</c:if>>PHP</option>
							                
							                 <option value="Python" <c:if test="${user.programming_language eq 'Python'}">selected</c:if> >Python</option>
							                <option value="SQL" <c:if test="${user.programming_language eq 'SQL'}">selected</c:if> >SQL</option>
							                <option value="OBJECT_C" <c:if test="${user.programming_language eq 'OBJECT_C'}">selected</c:if> >OBJECT_C</option>
							                 <option value="C#" <c:if test="${user.programming_language eq 'C#'}">selected</c:if> >C#</option>
							                <option value=".NET" <c:if test="${user.programming_language eq '.NET'}">selected</c:if> >.NET</option>
							            </select>
                                    </div>
                                    </div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="good_at_database" name="good_at_database" class="chosen-select" id="form-field-select-3" data-placeholder="Choose a State...">
							                <option value="ORACLE" <c:if test="${user.good_at_database eq 'ORACLE'}">selected</c:if> >ORACLE</option>
							                <option value="MYSQL" <c:if test="${user.good_at_database eq 'MYSQL'}">selected</c:if> >MYSQL</option>
							                <option value="SQL server" <c:if test="${user.good_at_database eq 'SQL server'}">selected</c:if> >SQL server</option>
							                 <option value="DB2" <c:if test="${user.good_at_database eq 'DB2'}">selected</c:if> >DB2</option>
							                <option value="Sybase" <c:if test="${user.good_at_database eq 'Sybase'}">selected</c:if> >Sybase</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="server"  name="server"  class="chosen-select" id="form-field-select-3" data-placeholder="Choose a State...">
							                <option value="Tomcat"<c:if test="${user.server eq 'Tomcat'}">selected</c:if> >Tomcat</option>
							                <option value="WebLogic" <c:if test="${user.server eq 'WebLogic'}">selected</c:if> >WebLogic</option>
							                <option value="JBoss" <c:if test="${user.server eq 'JBoss'}">selected</c:if> >JBoss</option>
							                 <option value="WebSphere" <c:if test="${user.server eq 'WebSphere'}">selected</c:if> >WebSphere</option>
							                <option value="Apache" <c:if test="${user.server eq 'Apache'}">selected</c:if> >Apache</option>
							                
							                 <option value="Nginx" <c:if test="${user.server eq 'Nginx'}">selected</c:if> >Nginx</option>
							            </select>
                                    </div>
                                    </div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="native_language" name="native_language" class="chosen-select" id="form-field-select-3" data-placeholder="Choose a State...">
							                <option value="AL" <c:if test="${user.native_language eq 'AL'}">selected</c:if> >汉语</option>
							                <option value="AK" <c:if test="${user.native_language eq 'AK'}">selected</c:if> >法语</option>
							                <option value="AZ" <c:if test="${user.native_language eq 'AZ'}">selected</c:if> >英语（英国）</option>
							                <option value="AZ" <c:if test="${user.native_language eq 'AZ'}">selected</c:if> >英语（美国）</option>
							            </select>
                                    </div>
                                    </div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
                                    <div class="input-group col-xs-10 col-sm-5">
										<select id="currency"  name="currency"  class="chosen-select"  data-placeholder="Choose a State...">
                           							<option value="AUD" <c:if test="${user.currency eq 'AUD'}">selected</c:if> >澳大利亚元</option>
                           							<option value="BRL" <c:if test="${user.currency eq 'BRL'}">selected</c:if> >巴西雷亚尔</option>
                           							<option value="GBP" <c:if test="${user.currency eq 'GBP'}">selected</c:if> >英镑</option>
                           							<option value="CAD" <c:if test="${user.currency eq 'CAD'}">selected</c:if> >加拿大元</option>
                           							<option selected="selected" value="CNY" <c:if test="${user.currency eq 'CNY'}">selected</c:if> >人民币</option>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input id="telephone"  name="telephone" type="text" class="form-control" placeholder="+国家代码 区号电话-电话号码-分机" value="${user.telephone}">
										</div>
									</div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input id="mobile_phone"  name="mobile_phone"  type="text"  class="form-control" placeholder="+国家代码 手机号码" value="${user.mobile_phone}">
										</div>
									</div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
										<textarea id="address"  name="address" maxlength="200"  class="col-xs-10 col-sm-5 limited" value="${user.address}">${user.address}</textarea>
									</div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
										<input id="city" name="city" type="text" placeholder="城市" class="col-xs-10 col-sm-5" value="${user.city}"/>
									</div>
								</div>
						...
						<div id="upload_img" class="modal fade" tabindex="-1">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<form id="uploadImage" class="form-horizontal" role="form" action="upload!saveUserImages.action?id=${user.id}" enctype="multipart/form-data" method="post">
										<input type="hidden" value="${user.id}" name="id">
											<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">选择图片文件<span class="required">*</span> </label>

									<div class="col-sm-9">
									<input id="imgFile"  name="imgFile" type="file" onchange="img_show(this,'preview');"/>
									</div>
								</div>
						...
						<div id="modal-table" class="modal fade" tabindex="-1">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<form name="updatePwd" class="form-horizontal" role="form" action="user!saveUserpw.action">
									...
									<div class="col-sm-9">
									  <input name="password" type="password" id="password" placeholder="新密码" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									  <input name="com_password" type="password" id="confirmPassword" placeholder="确认密码" class="col-xs-10 col-sm-5" />
									</div>
								</div>
