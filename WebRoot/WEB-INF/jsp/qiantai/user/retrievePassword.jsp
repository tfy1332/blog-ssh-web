...
.required {
    ...
    font-weight: bold;
		...
		<meta charset="utf-8" />
		<title>程序员忘记密码---找回密码-----请输入新密码(Coder)- Ace Admin</title>
		...
		function  add(){
	    	...
	    	var email=$("#email").val();
	    	 var password=$("#password").val();
		        ...
		        alert(2222);
		        window.location.href="user!saveUserpwByEmail.action?email="+email+"&password="+password;
		        /*
		        $.ajax({
			 		   type: "POST",
			 		   url: "user!saveUserpwByEmail.action",
					...
					<ul id="myTab" class="nav nav-tabs">
							...
							<!-- PAGE CONTENT BEGINS -->
								<!-- #section:elements.form -->
									...
									<form name="newPwd" id="newPwd" class="form-horizontal" role="form" action="user!saveUserpwByEmail.action" method="post">
								...
								<div class="modal-dialog">
									...
									<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">新密码--1<span class="required">*</span> </label>
