...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<%=request.getContextPath()%>/translator/assets/css/jquery.gritter.css" />
		<link rel="stylesheet" href="<%=request.getContextPath()%>/translator/assets/css/select2.css" />
		<link rel="stylesheet" href="<%=request.getContextPath()%>/translator/assets/css/datepicker.css" />
		<link rel="stylesheet" href="<%=request.getContextPath()%>/translator/assets/css/bootstrap-editable.css" />
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="forward!showForwardPage?username=<%= session.getAttribute("userID")%> ">
									<i class="menu-icon fa fa-caret-right"></i>
									上传图片
								</a>
				...
				<div class="page-content">
					...
					<div class="ace-settings-container" id="ace-settings-container">
						<div class="btn btn-app btn-xs btn-warning ace-settings-btn" id="ace-settings-btn">
							<i class="ace-icon fa fa-cog bigger-150"></i>						</div>
					...
					<div class="page-header">
						<h1>
							...
							<small>
								...
								3 styles with inline editable feature							</small>						</h1>
					</div><!-- /.page-header -->
				...
				<div class="tabbable">
					<ul id="myTab" class="nav nav-tabs">
							<li >
                                    ...
                                    <!--  
									<li>
									<a href="information_language.html" onClick="window.location.href='information_language.html';">
                                    ...
                                    <li>
									<a href="information_pay.html" onClick="window.location.href='information_pay.html';">
									...
									<div class="col-xs-12 col-sm-3 center">
										<div>
											...
											<span class="profile-picture">
												<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<%=request.getContextPath()%>/translator/assets/avatars/user1.jpg" />											</span>
...
&nbsp;
											...
											<div class="profile-skills">
																		<div class="progress">
																			<div class="progress-bar" style="width:90%">
																				<span class="pull-left">信用度</span>
																				<span class="pull-right">90%</span>																			</div>
																		</div>

																		<div class="progress">
																			<div class="progress-bar progress-bar-success" style="width:80%">
																				<span class="pull-left">好评率</span>
																		...
																		<div class="progress">
																			<div class="progress-bar progress-bar-warning" style="width:62%">
																				<span class="pull-left">测评级</span>

																				<span class="pull-right">62%</span>																			</div>
																		</div>

																		<div class="progress">
																			<div class="progress-bar progress-bar-danger" style="width:40%">
																				<span class="pull-left">贡献度</span>

																				<span class="pull-right">40%</span>																			</div>
																		</div>
																	</div>
										</div>
									...
									<div class="col-xs-12 col-sm-9">
                                        ...
                                        <div class="grjs">
                                              <div class="grjs1">女，北京市海淀区 中国 (UTC+08:00) 北京,重庆,香港,乌鲁木齐</div>
                                              <div class="gznx">
                                                   <div class="gznx1">工作年限：  8年</div>
                                                   <div class="gznx2"> 母语：  汉语</div>
                                          </div>
                                                <div class="gznx">
                                                   <div class="gznx1">状态： 正常</div>
                                                   <div class="gznx2"> 生日：  1986-02-14 </div>
                                               </div>
                                                <div class="gznx">
                                                   电话：  +86 010-72345678-231,+86 13145634561 
                                               </div>
                                               <div class="gznx">
                                                   <div class="grjj">个人简介：</div>
                                                   <div class="grjj1"> 活泼开朗、乐观向上、兴趣广泛、适应力强、勤奋好学、脚踏实地、认真负责、坚毅不拔、吃苦耐劳、勇于迎接新挑战。吃苦耐劳、勇于迎接吃苦耐劳、勇于迎接</div> 
                                               </div>
                                        </div>
                                        ...
                                        <div class="widget-box transparent">
											<div class="widget-header widget-header-small">
												<h4 class="widget-title blue smaller">
													...
													简体中文 -> 英语（美国） 测试级别：专业级												</h4>

												
											</div>
                                         
                                       
                                              <table width="100%" id="sample-table-2" class="table table-striped table-bordered ">
<tr>
<td bgcolor="#FFFFFF" class="center">领域</td>
<td bgcolor="#FFFFFF" class="center">服务类型</td>
<td bgcolor="#FFFFFF" class="center">年限（年）</td>
<td bgcolor="#FFFFFF" class="center">价格</td>
<td bgcolor="#FFFFFF" class="center">强度（每天）</td>
</tr>
<tr>
<td bgcolor="#FFFFFF">
经济---
...
<td bgcolor="#FFFFFF" class="center">翻译</td>
<td bgcolor="#FFFFFF"class="center">3</td>
<td bgcolor="#FFFFFF" class="center">CNY 5.50 /字</td>
<td bgcolor="#FFFFFF" class="center">347 /字</td>
</tr>
...
<td bgcolor="#FFFFFF" class="center" valign="middle">翻译</td>
<td bgcolor="#FFFFFF"class="center">1</td>
<td bgcolor="#FFFFFF" class="center">CNY 15.00 /字</td>
<td bgcolor="#FFFFFF" class="center">235 /字</td>
</tr>
<tr>
<td bgcolor="#FFFFFF">
历史---
...
<td bgcolor="#FFFFFF" class="center" valign="middle">同传</td>
<td bgcolor="#FFFFFF"class="center">1</td>
<td bgcolor="#FFFFFF" class="center">CNY 120.00 /字</td>
<td bgcolor="#FFFFFF" class="center">235 /字</td>
</tr>
</table>
...
<td bgcolor="#FFFFFF" class="center">235 /字</td>
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-small">
                                             ...
                                             <div class="gongzuo">
                                                    <div class="gongzuo1">
                                                            <div class="gongzuo1-1">2010年03月 至 2012年08月</div>  
                                                            <div class="gongzuo1-2">
                                                            香港忠创有限公司 | 董事长助理
                                                            </div>
                                                            <div class="gongzuo1-3">
                                                            工作概述：<br/>
设备开发、专利翻译和技术资料翻译。设备开发、专利翻译和技术资料翻译。设备开发、专利翻译和技术资料翻译
                                                            </div>
...
设备开发、专利翻译和技术资料翻译。设备开发、专利翻译和技术资料翻译。设备开发、专利翻译和技术资料翻译
                                           ...
                                           <div class="gz">
											...
											<div class="widget-header widget-header-small">
                                             ...
                                             <div class="gongzuo">
                                                    <div class="gongzuo1">
                                                            <div class="gongzuo1-1">2006年09月 至 2009年06月</div>  
                                                            <div class="gongzuo1-2">
                                                            国际翻译学 | 美国 | 耶鲁大学 | 博士
                                                            </div>
											...
											<div class="widget-header widget-header-small">
                                             ...
                                             <div class="gongzuo">
                                                    <div class="gongzuo1">
                                                            <div class="gongzuo1-2">
                                                            2008年09月 | 商务英语翻译证书四级翻译证书 | 商务部
                                                            </div>
                                                             <div class="gongzuo1-3">
                                                            证书描述：<br/>
全国外语翻译证书（NAETI)是由教育部考试中心与北京外国语大学合作举办，在全国实施的面向社会的非学历证书考试，主要测试应试者外语笔译和口译能力                                                            </div>
                                                          
                                                    </div>
                                                    <div class="fgx"></div>
                                                <div class="gongzuo1">
                                                            <div class="gongzuo1-2">
                                                            2014年02月 | 联合国语言培训体系认证P1 | unitar
                                                            </div>
                                                             <div class="gongzuo1-3">
                                                            证书描述：<br/>
根据联合国大会1963年12月11日1934号（ⅩⅧ）决议成立于1965年，是联合国专门专注于培训和培训相关研究的机构。                                                           </div>
										...
										<div class="tab-content no-border padding-24">
											<div id="home" class="tab-pane in active">
												<div class="row">
													<div class="col-xs-12 col-sm-3 center">
														<span class="profile-picture">
															<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="<%=request.getContextPath()%>/translator/assets/avatars/profile-pic.jpg" />														</span>
												...
												<div class="profile-feed row">
													<div class="col-sm-6">
														<div class="profile-activity clearfix">
															<div>
																<img class="pull-left" alt="Alex Doe's avatar" src="<%=request.getContextPath()%>/translator/assets/avatars/avatar5.png" />
														...
														<div class="profile-activity clearfix">
															<div>
																<img class="pull-left" alt="Susan Smith's avatar" src="<%=request.getContextPath()%>/translator/assets/avatars/avatar1.png" />
														...
														<div class="profile-activity clearfix">
															<div>
																<img class="pull-left" alt="David Palms's avatar" src="<%=request.getContextPath()%>/translator/assets/avatars/avatar4.png" />
												...
												<div class="profile-users clearfix">
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar4.png" alt="Bob Doe's avatar" />																</a>															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar1.png" alt="Rose Doe's avatar" />																</a>															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar.png" alt="Jim Doe's avatar" />																</a>															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar5.png" alt="Alex Doe's avatar" />																</a>															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar2.png" alt="Phil Doe's avatar" />																</a>															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar3.png" alt="Susan Doe's avatar" />																</a>															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar1.png" alt="Jennifer Doe's avatar" />																</a>															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="#">
																	<img src="<%=request.getContextPath()%>/translator/assets/avatars/avatar3.png" alt="Alexa Doe's avatar" />																</a>															</div>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							...
							Application &copy; Copyright 2014 TFY(2013-4-23)程序员的成长之路,路漫漫其修远兮,吾将上下而求索!天问。					</span>
...
<![endif]-->
		...
		<script src="<%=request.getContextPath()%>/translator/assets/js/jquery.gritter.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/bootbox.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/jquery.easypiechart.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/date-time/bootstrap-datepicker.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/jquery.hotkeys.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/bootstrap-wysiwyg.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/select2.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/fuelux/fuelux.spinner.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/x-editable/bootstrap-editable.min.js"></script>
		<script src="<%=request.getContextPath()%>/translator/assets/js/x-editable/ace-editable.min.js"></script>
