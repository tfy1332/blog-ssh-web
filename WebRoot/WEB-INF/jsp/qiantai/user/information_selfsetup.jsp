...
.required {
    ...
    font-weight: bold;
		...
		<meta charset="utf-8" />
		<title>程序员个性设置(Coder)- Ace Admin</title>
					...
					<ul id="myTab" class="nav nav-tabs">
							...
							<form class="form-horizontal" role="form">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> 个性设置<span class="required">*</span></label>

									<div class="col-sm-9">
									  <label class="col-xs-2 no-padding-left"><input type="checkbox" class="ace" name="form-field-checkbox" checked><span class="lbl"> 公开信息</span></label>
                                      <label class="col-xs-2  no-padding-left"><input type="checkbox" class="ace" name="form-field-checkbox" checked><span class="lbl"> 接收网站通讯</span></label>
